  ...
  <div class="customer-portrait-analysis">
    ...
    <a-card :bordered="false">
      ...
      <a-row :gutter="16" style="margin-bottom: 16px">
        ...
        <a-col :span="6">
          <a-card :bordered="false">
            <a-statistic
              title="客户占比"
              :value="statistics.customerRatio"
              suffix="%"
              :precision="2"
      ...
      <a-row :gutter="16">
        ...
        <a-col :span="24" style="margin-bottom: 16px">
          <a-card title="月度客户趋势" :bordered="false" class="chart-card">
        ...
        <!-- 业务员排名 -->
        <a-col :span="12" style="margin-bottom: 16px">
          <a-card title="业务员客户排名（Top 10）" :bordered="false" class="chart-card">
        ...
        <!-- 每日新签趋势 -->
        <a-col :span="24" style="margin-bottom: 16px">
          <a-card title="每日客户趋势" :bordered="false" class="chart-card">
        ...
        <!-- 业务人员月度明细 -->
        <a-col :span="24">
          <a-card title="业务人员客户月度明细" :bordered="false" class="table-card">
    ...
    >
      ...
      >
        ...
        <template slot="customerStatus" slot-scope="text, record">
          <a-tag :color="record.customerStatus === 1 ? 'red' : 'default'" style="margin: 0">
            {{ record.customerStatus === 1 ? '活跃' : '正常' }}
          </a-tag>
        </template>
      </a-table>
    </j-modal>
  ...
  methods: {
    ...
    async loadOrderList(salesman, month) {
      ...
      try {
        ...
        const res = await getAction('/customer/ghCustomer/getCustomerSalesmanMonthlyCustomers', params)
    ...
    async loadData() {
      ...
      try {
        ...
        console.log('开始加载客户画像数据，参数:', params)
        
        // 第一步：先加载统计数据（最快）
        const statsRes = await getAction('/customer/ghCustomer/getCustomerStatistics', params)
        ...
        const detailRes = await getAction('/customer/ghCustomer/getCustomerSalesmanMonthlyDetail', params)
