<template>
  <div class="task-center-analysis">
...
<script>
import TaskTabContent from './modules/TaskTabContent'

export default {
  name: 'TaskCenterAnalysis',
  components: {
    TaskTabContent,
  },
  data() {
  ...
  methods: {
    ...
    loadCurrentTabData() {
      const tabRef = this.activeTab === 'once' ? this.$refs.onceTab : this.$refs.recurringTab
