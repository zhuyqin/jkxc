<template>
  <div class="user-wrapper" :class="theme">
    ...
    <span class="action hzb-bank-entry">
      <a
        class="hzb-bank-link"
        target="_blank"
        rel="noopener noreferrer"
        href="https://xyt.hzbchina.com.cn/"
        title="打开杭州银行网站"
      >
        <a-icon type="bank" />
        <span v-if="isDesktop()">&nbsp;杭州银行</span>
        <a-tag v-if="isDesktop()" color="blue" class="hzb-bank-tag">快速跳转</a-tag>
      </a>
    </span>
